...
const electronAPI = {
  ...
  onAuthSessionChanged: registerListener(
...
if (EGGHEADS_DICTATION_ONLY) {
  [
    ...
    "cancelCudaWhisperDownload",
    "deleteCudaWhisperBinary",
    ...
    "checkParakeetModelStatus",
    "listParakeetModels",
    "deleteParakeetModel",
    "deleteAllParakeetModels",
    "cancelParakeetDownload",
    "getParakeetDiagnostics",
    "parakeetServerStart",
    "parakeetServerStop",
    "parakeetServerStatus",
